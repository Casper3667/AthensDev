...
var/station_name		= "Athen Station"
var/const/station_orig	= "Athens Station" //station_name can't be const due to event prefix/suffix
var/const/station_short	= "Athens Station"
